...
async def bloomberg_get_intraday_bars(params: IntradayBarsInput) -> str:
    ...
    """
    with log_tool_call("bloomberg_get_intraday_bars",
        ...
        try:
            ...
            ctx["error"] = True
            return fallback_or_error(e, "bloomberg_get_intraday_bars")
...
async def bloomberg_get_intraday_ticks(params: IntradayTicksInput) -> str:
    ...
    """
    with log_tool_call("bloomberg_get_intraday_ticks",
                       securities=[params.security]) as ctx:
        try:
            pre_request()
            ...
            ctx["error"] = True
            return fallback_or_error(e, "bloomberg_get_intraday_ticks")
